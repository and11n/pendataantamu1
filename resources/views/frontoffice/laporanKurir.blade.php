...
@section('content')
    ...
    <div class="d-flex flex-column gap-3 bg-white p-3 shadow">
        <div class="d-flex gap-3 align-items-center bg-white p-3 shadow">
            <form action="{{ route('frontoffice.laporanKurir') }}" method="GET">
            ...
            <div class="d-flex gap-3">
                <form method="GET" action="{{ route('frontoffice.laporanKurir') }}" id="filterForm">
            ...
            {{-- <div class="d-flex gap-3">
                ...
                <a href="{{ route('admin_export.pdf') }}" class="btn btn-danger">Export to PDF</a>
            </div> --}}
        </div>
