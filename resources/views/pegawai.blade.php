            ...
            <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    <label for="ptkDropdown" class="col-sm-2 col-form-label">PTK</label>
                                    <div class="col-sm-10">
                                        <select class="form-select" aria-label="Default select example">
                                            <option selected>Open this select menu</option>
                                            <option value="option1">Bahasa Indonesia</option>
                                            <option value="option2">Matematika</option>
                                            <option value="option3">Produktif</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">
                            <div class="col-sm-12 col-xl-12">
                                <div class="bg-light rounded h-100 p-4">
                                <h6 class="mb-4">Tabel Data Pegawai</h6>
