    ...
    <div class="d-flex flex-column gap-3 bg-white p-3 shadow">
        <div class="d-flex gap-3 align-items-center bg-white p-3 shadow">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="{{ route('admin.export.pdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" class="btn btn-success">Export Rekap</a>
                <a href="{{ route('admin.export.pdflaporan') }}" class="btn btn-danger">Export to PDF</a>
            </div>
        </div>
