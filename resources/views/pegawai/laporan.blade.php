...
@section('content')
    ...
    <div class="d-flex flex-column gap-3 bg-white p-3 shadow">
        <div class="d-flex gap-3 align-items-center bg-white p-3 shadow">
            <form action="{{ route('pegawai.laporan') }}" method="GET">
            ...
            <div class="d-flex gap-3">
                <form method="GET" action="{{ route('pegawai.laporan') }}" id="filterForm">
            ...
            <div class="d-flex gap-3">
                <a href="{{ route('pegawai.export.pdf') }}" class="btn btn-primary">Export to PDF</a>
            </div>
        </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><b>Waktu Pertemuan :</b> {{ $tamu->waktu_kedatangan }}</p>
                                                <b>Foto:</b> <br><img src="{{ Storage::url('public/' . $tamu->foto) }}" alt="Foto Tamu" class="img-fluid"><br>
                                                @if ($tamu->foto != null)
